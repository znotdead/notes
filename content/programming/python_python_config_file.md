Title: PYTHON: python config file
Date: 2011-12-09 13:36
Modified: 
Category: Programming
Tags: Python
Slug: python_python_config_file
Lang: en
Authors: znotdead
...
This enables autocompletion, history, pretty print, django env, color, editing in default editor in usual python interpreter:
```python
# place in .bashrc
...
# load up your favorite editor to edit lines of code from the interpreter
...
%(Normal)s""" % _c
```
[pythonrc](https://gist.github.com/772707)
